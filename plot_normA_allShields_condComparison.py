...
def main():
    ...
    folder = f"FullOrder/allShields_{rows}Row"
    save_folder = f'figures/normA/{folder}'
    save_dir = f"{save_folder}/normA_allShields_{rows}Rows_marcos_againstDefaultFullOrder.pdf"
    ...
    load_name_def = f"FullOrder/default/FrequencySweepMHIGradXNormA.mat"
